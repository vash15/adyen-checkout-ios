...
//        Checkout.shared.publicKey = "10001|"
    ...
    func sendPayment(payment: CheckoutPayment, completionHandler handler: (psp: String?, NSError?) -> Void) {
        ...
        do {
            ...
            let request = NSMutableURLRequest(URL: NSURL(string: "https://merchant-pay.parseapp.com/payment")!)
            ...
            NSURLConnection.sendAsynchronousRequest(request, queue: NSOperationQueue.mainQueue()) { (resp, data, error) -> Void in
                do {
                    ...
                    if let psp = jsonResult["pspReference"] as? String {
                        ...
                        handler(psp: nil, NSError(domain: "com.Adyen.Checkout", code: 0, userInfo: [NSLocalizedDescriptionKey: message]))
                    } else {
